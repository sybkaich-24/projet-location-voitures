...
1) Le dossier modele contient l'ensemble des entiter de la tables, ainsi que l'ensemble des fonction/methode permettant d'interagir avec la base de donnée 
